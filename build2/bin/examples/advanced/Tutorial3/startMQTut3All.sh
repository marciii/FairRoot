...
tut3cfg="/home/marci/fair_install/FairRoot/build2/bin/config/tut3-all.json"
...
xterm -geometry 80x23+0+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/$SPLITTER &
...
xterm -geometry 80x23+1000+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/$MERGER &
