...
tut3cfg="/home/marci/fair_install/FairRoot/build2/bin/config/tut3-all-proxy.json"

SAMPLER="tut3-sampler"
SAMPLER+=" --id sampler1"
SAMPLER+=" --data-format $dataFormat"
SAMPLER+=" --chain-input 99"
SAMPLER+=" --input-file /home/marci/fair_install/FairRoot/examples/advanced/Tutorial3/macro/data/testdigi_$mcEngine.root"
SAMPLER+=" --parameter-file /home/marci/fair_install/FairRoot/examples/advanced/Tutorial3/macro/data/testparams_$mcEngine.root"
SAMPLER+=" --mq-config $tut3cfg"
xterm -geometry 80x23+0+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/advanced/Tutorial3/$SAMPLER &

PROXY1="proxy"
PROXY1+=" --id proxy1"
PROXY1+=" --severity debug"
PROXY1+=" --in-channel data1"
PROXY1+=" --out-channel data2"
PROXY1+=" --mq-config $tut3cfg"
xterm -geometry 80x23+0+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/$PROXY1 &
...
xterm -geometry 80x23+500+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/advanced/Tutorial3/$PROCESSOR1 &
...
xterm -geometry 80x23+500+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/advanced/Tutorial3/$PROCESSOR3 &

PROXY2="proxy"
PROXY2+=" --id proxy2"
PROXY2+=" --severity debug"
PROXY2+=" --in-channel data3"
PROXY2+=" --out-channel data4"
PROXY2+=" --mq-config $tut3cfg"
xterm -geometry 80x23+1000+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/$PROXY2 &
...
xterm -geometry 80x23+1000+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/advanced/Tutorial3/$FILESINK &
