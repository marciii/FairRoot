...
OUTPUTFILE="/home/marci/fair_install/FairRoot/examples/MQ/serialization/data_io/outputEx1.root"
JSONCONFIGFILE="/home/marci/fair_install/FairRoot/examples/MQ/serialization/options/MQConfig.json"

########################## start SAMPLER
SAMPLER="serialization-Ex1-Sampler --transport $TRANSPORT --severity $VERBOSE"
...
PROCESSOR1="serialization-Ex1-Processor --transport $TRANSPORT --severity $VERBOSE"
...
PROCESSOR3="serialization-Ex1-Processor --transport $TRANSPORT --severity $VERBOSE"
...
########################## start FILESINK
FILESINK="serialization-Ex1-Sink --transport $TRANSPORT --severity $VERBOSE"
