...
MQCONFIGFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/run/options/Pixel9MQConfig_Merger3Ch.json"
...
OUTPUTFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.hitsFromBinary.3Ch.root"
...
xterm -geometry 80x25+0+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/$SERVER &
...
xterm -geometry 80x25+0+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR1 &
...
xterm -geometry 80x25+500+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$SAMPLER2 &
...
xterm -geometry 80x25+1000+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$SAMPLER3 &

########################## start PROCESSORs
PROCESSOR3="ex9-processor $TRANSPORT"
PROCESSOR3+=" $VERBOSE"
PROCESSOR3+=" --id processor3 $FAIRTASKNAME --mq-config $MQCONFIGFILE"
xterm -geometry 80x25+1000+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR3 &

########################## start MERGER
MERGER="ex9-merger $TRANSPORT"
MERGER+=" $VERBOSE"
MERGER+=" --id merger1 --mq-config $MQCONFIGFILE"
xterm +aw -geometry 80x25+500+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$MERGER &
