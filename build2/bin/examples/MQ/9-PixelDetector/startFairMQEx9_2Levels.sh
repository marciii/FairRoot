...
MQCONFIGFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/run/options/Pixel9MQConfig_2Levels.json"
...
if [ "$FAIRTASKNAME1" == "--task-name PixelFindHits" -a "$FAIRTASKNAME2" == "--task-name PixelFindTracks" ] ; then
    ...
    OUTPUTFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.2Levels.hits_tracks.root"
    ...
    # output file for sink
    OUTPUTFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.2Levels.hits_fitTracks.root"
    OUTPUTCLASS="--class-name TClonesArray(PixelHit) --class-name TClonesArray(PixelTrack)"
...
xterm -geometry 80x22+0+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/$SERVER &


########################## start SAMPLER
SAMPLER="ex9-sampler $TRANSPORT --severity info"
...
xterm -geometry 80x22+0+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$SAMPLER &
...
xterm -geometry 80x22+500+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR1_1 &
...
xterm -geometry 80x22+500+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR1_2 &
...
xterm -geometry 80x22+500+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR1_3 &
...
xterm -geometry 80x22+1000+0 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR2_1 &
...
xterm -geometry 80x22+1000+350 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR2_2 &
...
xterm -geometry 80x22+1000+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$PROCESSOR2_3 &
...
xterm +aw -geometry 80x22+0+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$FILESINK &
