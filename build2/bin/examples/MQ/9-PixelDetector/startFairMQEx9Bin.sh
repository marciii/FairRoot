...
if [ "$FAIRTASKNAME" == "--task-name PixelFindHits" ] ; then
 ...
 #   INPUTFILE+=" --file-name /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/pixel_TGeant3.digi.f1.root"
    ...
    OUTPUTFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.bin.hits.root"
...
########################## start SAMPLER
SAMPLER="ex9-samplerBin $TRANSPORT --severity info"
