...
if [ "$FAIRTASKNAME" == "--task-name PixelAltFindHits" ] ; then
    ...
    INPUTFILE="/home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/digisBin.$INPUTTYPE"
    INPUTFILE+=" --file-name /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/digisBin.$INPUTTYPE"
    INPUTFILE+=" --file-name /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/digisBin.$INPUTTYPE"
    INPUTFILE+=" --file-name /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/digisBin.$INPUTTYPE"
    INPUTFILE+=" --file-name /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/digisBin.$INPUTTYPE"
    INPUTFILE+=" --file-name /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/digisBin.$INPUTTYPE"
...
xterm +aw -geometry 80x25+0+700 -hold -e /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9-PixelDetector/$FILESINK &
