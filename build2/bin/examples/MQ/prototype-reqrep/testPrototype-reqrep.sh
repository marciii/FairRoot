...
PROCESSOR1="flpprocessorreqrep"
PROCESSOR1+=" --id flpprocessorreqrep"
...
/home/marci/fair_install/FairRoot/build2/bin/examples/MQ/prototype-reqrep/$PROCESSOR1 &
PROCESSOR1_PID=$!

PROCESSOR2="scheduleprocessorreqrep"
PROCESSOR2+=" --id scheduleprocessorreqrep"
...
/home/marci/fair_install/FairRoot/build2/bin/examples/MQ/prototype-reqrep/$PROCESSOR2 &
PROCESSOR2_PID=$!

PROCESSOR3="epnprocessorreqrep"
PROCESSOR3+=" --id epnprocessorreqrep"
...
/home/marci/fair_install/FairRoot/build2/bin/examples/MQ/prototype-reqrep/$PROCESSOR3 &
PROCESSOR3_PID=$!
