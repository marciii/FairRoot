...
cd /home/marci/fair_install/FairRoot/build2/examples/MQ/9-PixelDetector/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /home/marci/fair_install/FairRoot/examples/MQ/9-PixelDetector/macros/run_digiToBin.C\($parameters\)
