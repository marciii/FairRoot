...
cd /home/marci/fair_install/FairRoot/build2/examples/MQ/9a-PixelDetector/run

source  /home/marci/fair_install/FairRoot/build2/bin/examples/MQ/9a-PixelDetector/startFairMQEx9aFromBin_Static.sh
