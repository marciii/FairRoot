...
cd /home/marci/fair_install/FairRoot/build2/examples/advanced/MbsTutorial/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /home/marci/fair_install/FairRoot/examples/advanced/MbsTutorial/macros/unpack_mbs.C\($parameters\)
