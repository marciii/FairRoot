...
cd /home/marci/fair_install/FairRoot/build2/examples/advanced/Tutorial3/macro

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /home/marci/fair_install/FairRoot/examples/advanced/Tutorial3/macro/run_reco_timebased.C\($parameters\)
