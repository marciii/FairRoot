...
cd /home/marci/fair_install/FairRoot/build2/examples/simulation/Tutorial1/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /home/marci/fair_install/FairRoot/examples/simulation/Tutorial1/macros/run_tutorial1_pythia6.C\($parameters\)
