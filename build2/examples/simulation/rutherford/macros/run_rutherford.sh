...
cd /home/marci/fair_install/FairRoot/build2/examples/simulation/rutherford/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /home/marci/fair_install/FairRoot/examples/simulation/rutherford/macros/run_rutherford.C\($parameters\)
