...
cd /home/marci/fair_install/FairRoot/build2/examples/simulation/Tutorial4/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /home/marci/fair_install/FairRoot/examples/simulation/Tutorial4/macros/run_tutorial4.C\($parameters\)
